...
import { faCamera, faCode, faVial, faVirus } from "@fortawesome/free-solid-svg-icons";
...
export default function QuickSection() {
  return (
    <section className={cls.quick_section}>
      <h1 className={cls.section_header}>
        quick options
        </h1>
        ...
        <div className={cls.container}>
          <div className={cls.box}>
            ...
            <ButtonAsLink href='index.html' button_type='inline' btn_action='click'>
                view likes</ButtonAsLink>
            <p>Total comments: <span>14</span></p>
            <ButtonAsLink href='index.html' button_type='inline' btn_action='click'>
                view comments</ButtonAsLink>
            <p>Total comments: <span>14</span></p>
            <ButtonAsLink href='index.html' button_type='inline' btn_action='click'>
                view comments</ButtonAsLink>
          </div>
          <div className={cls.box}>
            ...
            {/* ОТображение групп. */}
            <div className={cls.category_flex}>
          ...
          <div className={cls.box}>
            ...
            <ButtonAsLink href='index.html' button_type='inline' btn_action='click'>Стать преподавателем</ButtonAsLink>
          </div>
        </div>
